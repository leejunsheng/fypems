            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-12 col-lg-9 col-xl-7">
                    ...
                    if ($_POST) {
                        ...
                        if (empty($role)) {
                            $error_msg .= "<div>Please select your role.</div>";
                        }
                        ...
                        if (!empty($error_msg)) {
                            ...
                            try {
                                // insert query
                                $query = "INSERT INTO employee SET username=:username, image=:image, password=:password, firstname=:firstname, lastname=:lastname,gender=:gender,datebirth=:datebirth,registration_dt=:registration_dt,role=:role,department=:department,accstatus=:accstatus";
                                ...
                                if ($stmt->execute()) {
                                    if (isset($_SESSION["login"])) {
                                        header("Location: employee_read.php?action=created");
                                    } else {
