            ...
            <ul class="list-unstyled components mt-5">
                ...
                <li>
                        ...
                        <ul class="collapse list-unstyled" id="pagemenu2">
                            ...
                            <li>
                                <a class="nav-link text-decoration-none" href="attendance.php">Add Attendance</a>
                            </li>

                            <li>
                                <a class="nav-link text-decoration-none" href="attendance_read.php">Attendance Record</a>
                            </li>
                        </ul>
                    </li>
                ...
                <li>
                    <a href="#pageSubmenu3" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle text-decoration-none nav-link">Work Tour <i class="fa-solid fa-briefcase"></i></a>
                ...
                <li>
                    <a href="#pageSubmenu4" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle text-decoration-none nav-link">Leave <i class="fa-regular fa-envelope"></i></a>
                ...
                <li>
                    <a href="#pageSubmenu5" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle text-decoration-none nav-link"> Notice <i class="fa-solid fa-bullhorn"></i></a>
